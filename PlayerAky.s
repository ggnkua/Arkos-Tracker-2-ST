...
;        moveymw d7,$ffff8800
        moveym #\frequency,$ffff8800
        moveym (a1)+,$ffff8802
;        add.w #1<<8,d7                                          ;Increases the frequency register.

;        moveymw d7,$ffff8800
		moveym #\frequency+1,$ffff8800
        moveym (a1)+,$ffff8802
;        add.w #1<<8,d7                                          ;Increases the frequency register.
...
PLY_AKYst_RRB_IS_SAH_AfterNoise:
        ...
        ;Reads the software period.
;        moveymw d7,$ffff8800
        moveym #\frequency,$ffff8802
        moveym (a1)+,$ffff8802
                
;        add.w #1<<8,d7                                          ;Increases the frequency register.

;        moveymw d7,$ffff8800
        moveym #\frequency+1,$ffff8802
        moveym (a1)+,$ffff8802
