...
PLY_AKYst_Init_SkipHeaderEnd:
        move.l a0,PLY_AKYst_PtLinker - PLY_AKYst_Init(a4)
        move.w #PLY_AKYst_OPCODE_SZF,d0
        move.w d0,PLY_AKYst_Channel1_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.w d0,PLY_AKYst_Channel2_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.w d0,PLY_AKYst_Channel3_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
...
;----------------------------------------
        ...
        move.w d1,PLY_AKYst_PatternFrameCounter - PLY_AKYst_Init(a4)
...
PLY_AKYst_LinkerNotEndSong:
        ...
        move.l a6,PLY_AKYst_PtLinker - PLY_AKYst_Init(a4)
...
PLY_AKYst_Channel1_RegisterBlock_Finished:
        ...
        move.w #PLY_AKYst_OPCODE_SZF,PLY_AKYst_Channel1_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.w PLY_AKYst_Channel1_PtTrack(pc),a6
        lea (a0,a6.w),a6
        move.b (a6),d1                                          ;Gets the duration.
        move.w 2(a6),a1                                         ;Reads the RegisterBlock address.
        lea (a0,a1.w),a1
        move.l a1,PLY_AKYst_Channel1_PtRegisterBlock - PLY_AKYst_Init(a4)
        addq.w #4,a6
...
PLY_AKYst_Channel2_RegisterBlock_Finished:
        ;This RegisterBlock is finished. Reads the next one from the Track.
        ;Obviously, starts at the initial state.
        move.w #PLY_AKYst_OPCODE_SZF,PLY_AKYst_Channel2_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.w PLY_AKYst_Channel2_PtTrack(pc),a6
        lea (a0,a6.w),a6
        move.b (a6),d1                                          ;Gets the duration (b1-7). b0 = silence block?
        move.w 2(a6),a1
        lea (a0,a1.w),a1
        move.l a1,PLY_AKYst_Channel2_PtRegisterBlock - PLY_AKYst_Init(a4)
        addq.w #4,a6
        sub.l a0,a6                                             ;TODO can we do without this?
        move.w a6,PLY_AKYst_Channel2_PtTrack - PLY_AKYst_Init(a4)
        ;d1 is the duration of the block.
...
PLY_AKYst_Channel3_RegisterBlock_Finished:
        ;This RegisterBlock is finished. Reads the next one from the Track.
        ;Obviously, starts at the initial state.
        move.w #PLY_AKYst_OPCODE_SZF,PLY_AKYst_Channel3_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.w PLY_AKYst_Channel3_PtTrack(pc),a6
        lea (a0,a6.w),a6
        move.b (a6),d1                                          ;Gets the duration (b1-7). b0 = silence block?
        move.w 2(a6),a1
        lea (a0,a1.w),a1
        move.l a1,PLY_AKYst_Channel3_PtRegisterBlock - PLY_AKYst_Init(a4)
        addq.w #4,a6
        sub.l a0,a6                                             ;TODO can we do without this?
        move.w a6,PLY_AKYst_Channel3_PtTrack - PLY_AKYst_Init(a4)
...
PLY_AKYst_Channel1_RegisterBlock_Return:
        move.w #PLY_AKYst_OPCODE_CZF,PLY_AKYst_Channel1_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.l a1,PLY_AKYst_Channel1_PtRegisterBlock - PLY_AKYst_Init(a4)
...
PLY_AKYst_Channel2_RegisterBlock_Return:
        move.w #PLY_AKYst_OPCODE_CZF,PLY_AKYst_Channel2_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.l a1,PLY_AKYst_Channel2_PtRegisterBlock - PLY_AKYst_Init(a4)
...
PLY_AKYst_Channel3_RegisterBlock_Return:
        move.w #PLY_AKYst_OPCODE_CZF,PLY_AKYst_Channel3_RegisterBlockLineState_Opcode - PLY_AKYst_Init(a4)
        move.l a1,PLY_AKYst_Channel3_PtRegisterBlock - PLY_AKYst_Init(a4)
        ;Register 7 to d1.
        move.w d3,d1
...
PLY_AKYst_RRB_IS_HO_AfterNoiseM33:
        ...
        move.b (a1)+,PLY_AKYst_PsgRegister11+$1 - PLY_AKYst_Init(a4)
        bset #PLY_AKYst_RRB_SoundChannelBit,d3
        move.w d7,d0
        ext.w d0
        add.w d0,d0
