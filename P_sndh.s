...
;        ld (PLY_AKYst_PtLinker + 1),hl        ;HL now points on the Linker.
        move.w  a0,PLY_AKYst_PtLinker-PLY_AKYst_Init(a4)       ;HL now points on the Linker.

;        ld a,PLY_AKYst_OPCODE_OR_A
        move.l #PLY_AKYst_OPCODE_OR_A,d0
;        ld (PLY_AKYst_Channel1_RegisterBlockLineState_Opcode),a
        move.l d0,PLY_AKYst_Channel1_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
;        ld (PLY_AKYst_Channel2_RegisterBlockLineState_Opcode),a
        move.l d0,PLY_AKYst_Channel2_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
;        ld (PLY_AKYst_Channel3_RegisterBlockLineState_Opcode),a
        move.l d0,PLY_AKYst_Channel3_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
;        ld hl,1
;        ld (PLY_AKYst_PatternFrameCounter + 1),hl
        move.w #1,PLY_AKYst_PatternFrameCounter-PLY_AKYst_Init(a4)
...
;        ld (PLY_AKYst_PatternFrameCounter + 1),hl
        move.w a1,PLY_AKYst_PatternFrameCounter-PLY_AKYst_Init(a4)       ;*SMC galore!
...
;        ld (PLY_AKYst_PatternFrameCounter + 1),hl
        move.w a1,PLY_AKYst_PatternFrameCounter-PLY_AKYst_Init(a4)

;        pop hl
;        ld (PLY_AKYst_Channel1_PtTrack + 1),hl
        move.w (a6)+,PLY_AKYst_Channel1_PtTrack-PLY_AKYst_Init(a4)
;        pop hl
;        ld (PLY_AKYst_Channel2_PtTrack + 1),hl
        move.w (a6)+,PLY_AKYst_Channel2_PtTrack-PLY_AKYst_Init(a4)
;        pop hl
;        ld (PLY_AKYst_Channel3_PtTrack + 1),hl
        move.w (a6)+,PLY_AKYst_Channel3_PtTrack-PLY_AKYst_Init(a4)
;        ld (PLY_AKYst_PtLinker + 1),sp
        move.w a6,PLY_AKYst_PtLinker-PLY_AKYst_Init(a4)

        ;Resets the RegisterBlocks of the channels.
;        ld a,1
        moveq #1,d1
;        ld (PLY_AKYst_Channel1_WaitBeforeNextRegisterBlock + 1),a
        move.b d1,PLY_AKYst_Channel1_WaitBeforeNextRegisterBlock-PLY_AKYst_Init(a4)
;        ld (PLY_AKYst_Channel2_WaitBeforeNextRegisterBlock + 1),a
        move.b d1,PLY_AKYst_Channel2_WaitBeforeNextRegisterBlock-PLY_AKYst_Init(a4)
;        ld (PLY_AKYst_Channel3_WaitBeforeNextRegisterBlock + 1),a
        move.b d1,PLY_AKYst_Channel3_WaitBeforeNextRegisterBlock-PLY_AKYst_Init(a4)
...
;        ld (PLY_AKYst_Channel1_RegisterBlockLineState_Opcode),a
        move.l d1,PLY_AKYst_Channel1_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
...
;        ld (PLY_AKYst_Channel1_PtRegisterBlock + 1),hl
        move.w a1,PLY_AKYst_Channel1_PtRegisterBlock-PLY_AKYst_Init(a4)
...
;        ld a,PLY_AKYst_OPCODE_OR_A
        move.l #PLY_AKYst_OPCODE_OR_A,d1
;        ld (PLY_AKYst_Channel2_RegisterBlockLineState_Opcode),a
        move.l d1,PLY_AKYst_Channel2_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
...
;        ld (PLY_AKYst_Channel2_PtRegisterBlock + 1),hl
        move.w a1,PLY_AKYst_Channel2_PtRegisterBlock-PLY_AKYst_Init(a4)
        ;A is the duration of the block.
...
;        ld a,PLY_AKYst_OPCODE_OR_A
        move.l #PLY_AKYst_OPCODE_OR_A,d1
;        ld (PLY_AKYst_Channel3_RegisterBlockLineState_Opcode),a
        move.l d1,PLY_AKYst_Channel3_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
...
;        ld (PLY_AKYst_Channel3_PtRegisterBlock + 1),hl
        move.w a1,PLY_AKYst_Channel3_PtRegisterBlock-PLY_AKYst_Init(a4)
        ;A is the duration of the block.
...
;        ld (PLY_AKYst_Channel1_RegisterBlockLineState_Opcode),a
        move.l #PLY_AKYst_OPCODE_SCF,PLY_AKYst_Channel1_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
...
;        ld a,PLY_AKYst_OPCODE_SCF
;        ld (PLY_AKYst_Channel2_RegisterBlockLineState_Opcode),a
        move.l #PLY_AKYst_OPCODE_SCF,PLY_AKYst_Channel2_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
;        ld (PLY_AKYst_Channel2_PtRegisterBlock + 1),hl        ;This is new pointer on the RegisterBlock.
        move.w a1,PLY_AKYst_Channel2_PtRegisterBlock-PLY_AKYst_Init(a4)        ;This is new pointer on the RegisterBlock.
...
PLY_AKYst_Channel3_RegisterBlock_Return:
        ;ld a,PLY_AKYst_OPCODE_SCF
;        ld (PLY_AKYst_Channel3_RegisterBlockLineState_Opcode),a
        move.l #PLY_AKYst_OPCODE_SCF,PLY_AKYst_Channel3_RegisterBlockLineState_Opcode-PLY_AKYst_Init(a4)
;        ld (PLY_AKYst_Channel3_PtRegisterBlock + 1),hl        ;This is new pointer on the RegisterBlock.
        move.w a1,PLY_AKYst_Channel3_PtRegisterBlock-PLY_AKYst_Init(a4)        ;This is new pointer on the RegisterBlock.
...
;                ex af,af'
                move.b #6,$ffff8800
                move.b PLY_AKYst_PsgRegister6(pc),$ffff8802
...
;                ex af,af'
                move.b #11,$ffff8800
                move.b PLY_AKYst_PsgRegister11(pc),$ffff8802
...
;                ex af,af'
                move.b #12,$ffff8800
                move.b PLY_AKYst_PsgRegister12(pc),$ffff8802
...
;                ld (PLY_AKYst_PsgRegister13_Retrig + 1),a
                move.b d1,PLY_AKYst_PsgRegister13_Retrig-PLY_AKYst_Init(a4)
...
;        ldi                     ;Safe for B, C is not 0. Preserves A.
        move.b (a1),PLY_AKYst_PsgRegister6-PLY_AKYst_Init(a4)
        addq.w #1,a1
        addq.w #1,d2
        subq.w #1,d3
...
;        ld (PLY_AKYst_PsgRegister13),a
        move.b d1,PLY_AKYst_PsgRegister13-PLY_AKYst_Init(a4)

        ;Copies the hardware period.
;        ld de,PLY_AKYst_PsgRegister11
;        ldi
;        ldi
        move.b (a1),PLY_AKYst_PsgRegister11-PLY_AKYst_Init(a4)
        move.b 1(a1),PLY_AKYst_PsgRegister11+1-PLY_AKYst_Init(a4)
        addq.w #2,a1
        addq.w #2,d2
        subq.w #2,d3
...
;        ldi
        move.b (a1),PLY_AKYst_PsgRegister12-PLY_AKYst_Init(a4)
        addq.w #1,a1
        addq.w #1,d2
        subq.w #1,d3
...
;        ldi
        move.b (a1),PLY_AKYst_PsgRegister13-PLY_AKYst_Init(a4)
        addq.w #1,a1
        addq.w #1,d2
        subq.w #1,d3
